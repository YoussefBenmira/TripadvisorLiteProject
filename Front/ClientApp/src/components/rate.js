...
export var mouseClickedStarRating=false;
export function rateSystem(className, obj, fnc=function(){}, fncMove=function(){}, fncLeave=function(){}){
...
export function zmouseMoveStarRating(fncMove){
   ...
   export function zmouseMoveStarRatingClick(fnc){
        if(event.target.classList.contains("starRatingContainer")){
            let myDiv = event.target.getElementsByTagName("DIV")[0];
            if(!myDiv.classList.contains("readOnlyStarRating")){
...
export function zmouseMoveStarRatingLeave(fncLeave){
    if(!event.target.classList.contains("starRatingContainer")){
     /*    if(!event.target.classList.contains("readOnlyStarRating")){
   ...
   export function zmouseMoveStarRatingTouch(fncMove){
        try{
       ...
       export function zmouseMoveStarRatingLeaveTouch(fnc, fncLeave){
      ...
      export  function zmouseMoveStarRatingTouchMove(fncMove){
